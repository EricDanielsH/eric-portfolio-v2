...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="px-6 md:px-14 backdrop-blur w-full max-w-3xl h-full flex items-center justify-between">
        <Link href="/" className="flex items-end">
          <Image src="/meow.gif" alt="Cat gif" width={16} height={16} className="w-8 h-8" />
        </Link>
